...
from lib.memory import MemoryNStepReturns
from agent.pdqn import PDQNAgent
from lib.utils import soft_update_target_network
...
class PDQNNStepAgent(PDQNAgent):
    ...
    def __init__(self,
        ...
        self.replay_memory = MemoryNStepReturns(self.replay_memory_size, (self.observation_space_dim,),
