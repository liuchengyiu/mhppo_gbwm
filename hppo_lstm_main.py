...
from agent.hppo_lstm import HPPO
...
def evaluate_policy(args, env, agent, state_norm):
    ...
    for _ in range(times):
        ...
        while not done:
            ...
            s_, r, done = env.step(s, (a, (p[a*2:(a+1)*2]+1)/2))
            _s = state_norm(s_)
            episode_reward += r
            mu += param[0]
            infu += param[1]
    ...
    while total_steps < args.max_train_steps:
        ...
        while not done:
            ...
            if total_steps % args.batch_size == 0:
                ...
                writer.add_scalar('step_rewards_{}'.format("lstm_6"), evaluate_rewards[-1], global_step=total_steps)
                # Save the rewards
